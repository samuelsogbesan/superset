...
test('formatPermissionLabel preserves resource identifiers', () => {
  expect(
    formatPermissionLabel('can_read', '[analytics].[data_prod].[fact_orders]'),
  ).toBe('can read [analytics].[data_prod].[fact_orders]');
});
